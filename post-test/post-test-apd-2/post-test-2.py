...
tinggi_badan = int(input(f"{'Tinggi badan pasien (dalam cm)' :32}: "))
berat_badan = int(input(f"{'Berat badan pasien (dalam kg)' :32}: "))
...
print(f"{'|'} {'Tinggi Badan' :30}: {tinggi_badan:.2f} {' ' * (27 - len(str(tinggi_badan)))} {'|'}")
print(f"{'|'} {"Berat Badan" :30}: {berat_badan:.2f} {' ' * (27 - len(str(berat_badan)))} {'|'}")
print(f"{'|'} {'Berat Ideal' :30}: {berat_ideal:.2f} {' ' * (27 - len(str(berat_ideal)))} {'|'}")
